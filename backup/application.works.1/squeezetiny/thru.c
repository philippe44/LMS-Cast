...
/*---------------------------------------------------------------------------*/
static char* thru_mime(struct thread_ctx_s *ctx) {
	struct thru *p = ctx->decode.handle;
...
/*---------------------------------------------------------------------------*/
static u64_t thru_size(struct thread_ctx_s *ctx) {
	return 0;
}

/*---------------------------------------------------------------------------*/
static void thru_open(struct track_param *param, struct thread_ctx_s *ctx) {
	struct thru *p = ctx->decode.handle;
...
struct codec *register_thru(void) {
	static struct codec ret = {
		...
		thru_close,  // close
		thru_decode, // decode
		thru_mime,	 // get mime type
		thru_size,	 // get total length, 0 is unknown
	};
