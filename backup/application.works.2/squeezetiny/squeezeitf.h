...
typedef enum {SQ_NONE, SQ_SETFORMAT, SQ_SET_TRACK, SQ_PLAY, SQ_PAUSE, SQ_UNPAUSE, SQ_STOP, SQ_SEEK,
...
sq_dev_handle_t		sq_reserve_device(void *caller_id, bool on, char *mimecap[], sq_callback_t callback);
