...
my @xmldevice = qw(name mac sample_rate codecs next_uri mode enabled remove_timeout send_metadata volume_on_play volume_feedback send_coverart media_volume server);
