...
sub binaries {
	...
	if ($os->{'os'} eq 'Linux') {
		...
		if ($os->{'binArch'} =~ /arm/) {
			return qw(squeeze2cast-armv6hf squeeze2cast-armv6hf-static squeeze2cast-armv5 squeeze2cast-armv5-static);
		}
		...
		return qw(squeeze2cast-x86-64 squeeze2cast-x86-64-static squeeze2cast-x86 squeeze2cast-x86-static squeeze2cast-armv6hf squeeze2cast-armv6hf-static squeeze2cast-armv5 squeeze2cast-armv5-static squeeze2cast-ppc squeeze2cast-ppc-static);
	}
